  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
          ...
          <table style="border-color:blue; " border="0" cellspacing="0px" width="800"
            ...
            <tbody>
              ...
              <tr style="height:118px; " valign="top">
                ...
                <td width="60%" align="right" style="text-align:right" valign="bottom" colspan="2">
        ...
        <table id="budgetContainerTable" border="0" width="800px">
          <tr id="budgetContainerTr" align="right">
            <td id="budgetContainerDummyTd"/>
            <td id="lineTableBudgetTd" style="border:1px solid #CCC" align="right" width="200px">
              <span style="font-weight:bold; ">
                <xsl:text>Mal Hizmet Toplam Tutarı</xsl:text>
              </span>
            </td>
            <td id="lineTableBudgetTd" style="width:81px;border:1px solid #CCC;border-left:none" align="right">
          ...
          <xsl:for-each select="n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
            <xsl:if test="cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode = '4171'">
              <tr id="budgetContainerTr" align="right">
                <td id="budgetContainerDummyTd"/>
                <td id="lineTableBudgetTd" style="border:1px solid #CCC; border-top:none;" align="right" width="200px">
                  <span style="font-weight:bold; ">
                    <xsl:text>Teslim Bedeli</xsl:text>
                  </span>
                </td>
                <td id="lineTableBudgetTd" style="width:81px;border:1px solid #CCC; border-top:none; border-left:none" align="right">
                  <xsl:for-each select="//n1:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount">
                    <xsl:call-template name="Curr_Type"/>
                  </xsl:for-each>
                </td>
          ...
          <tr id="budgetContainerTr" align="right">
            <td id="budgetContainerDummyTd"/>
            <td id="lineTableBudgetTd" align="right" style="border:1px solid #CCC; border-top:none;" width="200px">
              <span style="font-weight:bold; ">
          ...
          <xsl:for-each select="n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
            <tr id="budgetContainerTr" align="right">
              <td id="budgetContainerDummyTd"/>
              <td id="lineTableBudgetTd" width="211px" style="border:1px solid #CCC; border-top:none;" align="right">
                <span style="font-weight:bold; ">
              ...
              <td id="lineTableBudgetTd" style="width:82px;border:1px solid #CCC; border-top:none; border-left:none " align="right">
          ...
          <xsl:for-each select="n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal">
            <tr id="budgetContainerTr" align="right">
              <td id="budgetContainerDummyTd"/>
              <td id="lineTableBudgetTd" style="border:1px solid #CCC; border-top:none;" width="211px" align="right">
                <span style="font-weight:bold; ">
          ...
          <tr id="budgetContainerTr" align="right">
            <td id="budgetContainerDummyTd"/>
            <td id="lineTableBudgetTd" style="border:1px solid #CCC; border-top:none;" width="200px" align="right">
              <span style="font-weight:bold; ">
          ...
          <xsl:if
            ...
            <tr align="right">
              <td/>
              <td id="lineTableBudgetTd" width="200px" style="border:1px solid #CCC; border-top:none;" align="right">
                <span style="font-weight:bold; ">
        ...
        <table id="notesTable"  align="left" >
          <tbody>
            <tr align="left">
              <td id="notesTableTd">
                <xsl:for-each select="//n1:Invoice/cac:TaxTotal/cac:TaxSubtotal">
        ...
        <div id="eArsivAlan" style="margin-top:10px">
          ...
          <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'IS_INTERNET']">
            ...
            <div id="internetSatis" style="margin-top:5px">
              <table class="intSatisBilgi"  style="border:1px solid #ccc; padding:4px; margin-top:10px" width="792" height="50" id="info">
                <tbody>
                  <tr>

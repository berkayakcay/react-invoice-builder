        ...
        <xsl:for-each select="$XML">
          ...
          <table
            ...
            <tbody>
              <tr>
                <td valign="top"
                  style="width:390px;border:0px solid orange; border-collapse:collapse;">
                  <table
                    style="width:390px;border:0px solid orange; border-collapse:collapse;border-top:1px dotted orange;">
                    <tbody>
                      <!--Tel-->
                      <xsl:choose>
                        <xsl:when
            ...
            <tbody>
              <tr valign="top">
                <td style="width:330px;" valign="top" rowspan="2" cellspacing="2px" cellpadding="2px">
                  <table style="width:430px;" align="left" border="0">
                    <tbody>
                      <tr>
                        <td colspan="2">
            ...
            <table id="lineTable" style="border:1px solid orange; border-collapse:collapse;"
              ...
              <tbody>
                <tr
                  ...
                  <td style="width:10%;border:1px solid orange;" align="center">
                    <span style="font-weight:bold; ">
                      <font color="navy">

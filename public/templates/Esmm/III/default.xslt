			...
			<body
				...
				<xsl:for-each select="$XML">
					<table style="border-color:blue; " border="0" cellspacing="0px" width="800"
						...
						<tbody>
							<tr valign="top">
								<td width="40%" style="vertical-align:middle;text-align:  center;">
									<table>
										<tbody>
											<tr>
												<td style="padding-top:10px"> {{LOGO}}
												<!--Logo Alanı-->
												</td>
											</tr>
											<tr>
												...
												><xsl:value-of
												select="NESVoucher/VoucherGeneralInfo/UUID"
												/></div>
												<script type="text/javascript">
								...
								<td width="20%" align="center" valign="middle">
									...
									<b style="color:red">DÜZENLEYEN / ISSUER</b><br/>
									<table align="center" border="0" width="100%">
										<tbody> <xsl:for-each select="NESVoucher/CompanyInfo">
												...
												<xsl:if test="./WebSite">
												<tr>
												<td> Web : <xsl:value-of select="./WebSite"/>
												</td>
												</tr>
												</xsl:if>
							...
							</tr> <tr style="height:118px; " valign="top">
								<td width="40%" style="padding-top:67px;"> <table
										class="despatchTable" style="float:left;">
										<tbody>
											<tr>
												<td> <xsl:text>Belge No / Document No</xsl:text> </td>
												<td>
												<xsl:for-each
											...
											<tr>
												<td>
												<xsl:text>Düzenlenme Tarihi / Issuance Date</xsl:text>
												</td>
												<td>
												<xsl:for-each
											...
											<tr>
												<td>
												<xsl:text>Düzenlenme Zamanı / Issuance Time</xsl:text>
												</td>
												<td>
												<xsl:for-each
								...
								<td width="20%" align="center"> {{IMZA}} <!--İmza Alanı-->
								</td> <td width="40%">
									<div class="hr" style="margin-bottom:5px"/>
									<b style="color:red">ALICI BİLGİLERİ / RECEIVER</b>
									<table align="center" border="0" width="100%">
										<tbody>
					...
					</table> <table style="border-color:blue; " border="0" cellspacing="0px"
						width="800" cellpadding="0px">
						<tr>
							<td align="right" valign="top" id="ettnTable">
								<span style="font-weight:bold; ">
				...
				<div style="width:800px">
					<table class="totalTable" width="800px"> <xsl:variable name="brutTotal"
						...
						<tr> <td>
								<xsl:text>Ara Toplam / Subtotal</xsl:text>
							</td>
							<td>
								<xsl:value-of
						...
						<tr> <td>
								<xsl:text>Stopaj / Withholding Tax</xsl:text>
							</td>
							<td>
								<xsl:value-of
						...
						<tr> <td>
								<xsl:text>Toplam Net / Total Net</xsl:text>
							</td>
							<td>
								<xsl:value-of
						...
						<tr> <td>
								<xsl:text>%18 KDV / %18 V.A.T</xsl:text>
							</td>
							<td>
								<xsl:value-of
						...
						<tr> <td>
								<xsl:text>KDV Tevkifat / Vat Deduction Ratio</xsl:text>
							</td>
							<td>
								<xsl:value-of
						...
						<tr>
							<td>
								<xsl:text>Tahsil Edilecek KDV / V.A.T</xsl:text>
							</td>
							<td>
								<xsl:value-of
						...
						<tr> <td>
								<xsl:text>Toplam Alacak / Amount Due</xsl:text>
							</td>
							<td>
								<xsl:value-of
